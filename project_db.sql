...
CREATE TABLE IF NOT EXISTS class_type (		-- лекція / практика
id INT(11) AUTO_INCREMENT NOT NULL,
name VARCHAR(255) NOT NULL,
PRIMARY KEY (id)
) ENGINE=InnoDB CHARACTER SET=UTF8;

CREATE TABLE IF NOT EXISTS class_period (	-- номер пари
id INT(11) AUTO_INCREMENT NOT NULL,
...
CREATE TABLE IF NOT EXISTS finals (			-- розклад сесії 
id INT(11) AUTO_INCREMENT NOT NULL,
