...
public class DBImitation {
	...
	private static void initClassTypes() {
		classTypes.add(new ClassType(1, "лекція"));
		classTypes.add(new ClassType(2, "практика"));
	}
	
	private static void initDays() {
		days.add(new Day(1, "Понеділок"));
		days.add(new Day(2, "Вівторок"));
		days.add(new Day(3, "Середа"));
		days.add(new Day(4, "Четвер"));
		days.add(new Day(5, "П`ятниця"));
		days.add(new Day(6, "Субота"));
	}
